#ifndef __wwtp3_sfun_h__
#define __wwtp3_sfun_h__
...
extern mxArray* load_wwtp3_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_wwtp3_optimization_info(void);
